...
import { getAuthorBooks } from "../../features/authors/authorsSlice";
import { useGetBooksQuery } from "../../features/books/bookApi";
import AuthorsUpdatePage from "./AuthorsUpdatePage";
...
function AuthorsDetailsPage() {
  ...
  const books = useSelector(getAuthorBooks(state?.id));
